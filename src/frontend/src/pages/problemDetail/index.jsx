          ...
          <header className="problem-header">
            <div className="problem-title-block">
              ...
              <div className="problem-meta">
                <span>Acceptance Rate: {problem.acceptanceRate != null ? `${problem.acceptanceRate}%` : '-'}</span>
                <span>•</span>
                <span>Total Attempts: {problem.totalSubmissions || 0}</span>
                <span>•</span>
                <span>Solved by: {problem.totalAccepted || 0} users</span>
              </div>
            </div>
